...
@numba.njit
def timeIntegration_njit_elementwise(startind, t, dt, sqrt_dt, duration, N, Cmat, Dmat, K_gl, signalV, coupling, Dmat_ndt, xs, ys, xs_input_d, ys_input_d, x_ext, y_ext, alpha, beta, gamma, delta, epsilon, tau, noise_xs, noise_ys, x_ou, y_ou, x_ou_mean, y_ou_mean, tau_ou, sigma_ou):
    """
...
@numba.njit
def jacobian_fhn(model_params, x, V, sv):
