...
FHN_DEFAULT_PARAMS = {'alpha': 3.0, 'beta': 4.0, 'gamma': -1.5, 'delta': 0.0, 'epsilon': 0.5, 'tau': 20.0, 'x_ext': 1.0, 'y_ext': 0.0}
...
class FitzHughNagumoMass(NeuralMass):
    ...
    required_params = ['alpha', 'beta', 'gamma', 'delta', 'epsilon', 'tau', 'x_ext', 'y_ext']
    required_couplings = ['network_x', 'network_y']
    _noise_input = [OrnsteinUhlenbeckProcess(mu=0.0, sigma=0.0, tau=5.0), OrnsteinUhlenbeckProcess(mu=0.0, sigma=0.0, tau=5.0)]
